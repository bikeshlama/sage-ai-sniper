  ...
  return (
    <div className="relative min-h-screen pt-24 pb-16 px-4 flex flex-col items-center justify-center text-center">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-10 -right-10 w-72 h-72 bg-indigo-500 opacity-10 blur-[100px] animate-float"></div>
        <div className="absolute -bottom-10 -left-10 w-72 h-72 bg-indigo-300 opacity-10 blur-[100px] animate-float" style={{ animationDelay: '-3s' }}></div>
      </div>

      {/* Main hero content */}
      <div className="max-w-4xl mx-auto z-10">
        <div className="inline-block mb-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-6 py-2 text-sm font-medium text-indigo-200">
        ...
        <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-300 via-indigo-200 to-indigo-100 neon-text">
            Memecoin Sniping
          </span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          <Link to="/register">
            <Button size="lg" className="bg-gradient-to-r from-indigo-600 to-indigo-400 hover:opacity-90 text-white px-8 relative overflow-hidden group">
              Get Started
              <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" size={18} />
            </Button>
          </Link>
          <Link to="/community">
            <Button size="lg" variant="outline" className="border-indigo-400 text-indigo-200 hover:bg-indigo-700/20">
              Join Community
            </Button>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
          ...
          <div className="glassmorphism p-6 rounded-lg">
            <div className="w-12 h-12 bg-indigo-300/20 rounded-lg flex items-center justify-center mb-4">
              <ChartBar className="text-indigo-300" size={24} />
            </div>
          ...
          <div className="glassmorphism p-6 rounded-lg">
            <div className="w-12 h-12 bg-indigo-200/20 rounded-lg flex items-center justify-center mb-4">
